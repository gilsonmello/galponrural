<?php
class Magentothem_Producttabs_Block_Adminhtml_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid {

    public function __construct() {
        parent::__construct();

        $this->setId('featureds');
    ...
    protected function _getSelectedProducts($json=false) {
        ...
        $_prod = Mage::getModel('catalog/product')->getCollection()
                ->joinAttribute('featured', 'catalog_product/featured', 'entity_id', null, 'left', $store->getId())
...
EndHTML;
    ...
    private function _appendHtml() {
		...
		var checkbox_all = $$("#featureds_table thead input.checkbox").first();
    	var everycheckbox = $$("#featureds_table tbody input.checkbox");
