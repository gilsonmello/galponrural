...
-------------------------------------------------------------------------*/ 
class Magentothem_Brandslider_Adminhtml_BrandsliderController extends Mage_Adminhtml_Controller_Action
{
		...
		if ($data = $this->getRequest()->getPost()) {
			...
			if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != null) {
				try {	
					...
					$path = Mage::getBaseDir('media') . DS.'magentothem/brandslider'.DS ;
		        ...
		        $basepath=Mage::getBaseUrl().'media/magentothem/brandslider/';
