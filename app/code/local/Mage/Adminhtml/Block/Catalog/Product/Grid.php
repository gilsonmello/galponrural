...
class Mage_Adminhtml_Block_Catalog_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getModel('catalog/product')->getCollection()
                ...
                ->addAttributeToSelect('fabricantes')
    ...
    protected function _prepareColumns() {
        ...
        $attribute = Mage::getSingleton('eav/config')->getAttribute('catalog_product', 'fabricantes');
        $options = array();
        ...
        $this->addColumn('fabricantes', array(
            'header' => Mage::helper('catalog')->__('Fabricante'),
            'width' => '100px',
            'type' => 'options',
            'index' => 'fabricantes',
            'options' => $options
